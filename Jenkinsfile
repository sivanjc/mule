def UPSTREAM_PROJECTS_LIST = [ "Mule-runtime/metadata-model-api/1.3.0-TEST-CYCLE-2020-DRY-RUN",
                               "Mule-runtime/mule-api/1.3.0-TEST-CYCLE-2020-DRY-RUN",
                               "Mule-runtime/mule-extensions-api/1.3.0-TEST-CYCLE-2020-DRY-RUN",
                               "Mule-runtime/mule-artifact-ast/0.8.0-TEST-CYCLE-2020-DRY-RUN",
                               "DataWeave/data-weave/support/2.3.0",
                               "Mule-runtime/mule-maven-client/1.5.0-TEST-CYCLE-2020-DRY-RUN" ]
