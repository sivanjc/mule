...
public class ComponentExecutionInitialSpanInfo implements InitialSpanInfo {
  ...
  private DataFromParentPuller<?> dataFromParentPuller;
  ...
  @Override
  public void addSpanExporterDataPuller(DataFromParentPuller<?> dataFromParentPuller) {
    this.dataFromParentPuller = dataFromParentPuller;
  }

  @Override
  public Optional<DataFromParentPuller<?>> getSpanExporterDataPuller() {
    return Optional.ofNullable(dataFromParentPuller);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o == null || getClass() != o.getClass())
      return false;
    ComponentExecutionInitialSpanInfo that = (ComponentExecutionInitialSpanInfo) o;
